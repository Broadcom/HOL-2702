...
* - * - * - * - * - * - * - * - * - * - * - * - * - * - * - * - * - * - * - * - *
*                       HOL-2702      Hands-On with Kubernetes: Essential Updates and Capabilities in VCF 9.1                      *
* - * - * - * - * - * - * - * - * - * - * - * - * - * - * - * - * - * - * - * - *
```
...
Module 1 provides an overview of the new features in VKS, VM Service, Container Service and Supervisor.  In modules 2-4 you'll get to experience these changes yourself. You'll deploy a cluster, VM, and Container using their respective services and learn day 2 operations for each. 
